...
public class TPC {
	...
	public void makeGeometry(){
		...
		this.addRect("anodeRect",beampiperadius,-electrodeThickness,TPCRadius-beampiperadius,1);
		this.addRect("cathodeRect",beampiperadius,TPCLength(),TPCRadius-beampiperadius,1);
		this.addFSEs();
	...
	public void makeAnodeSelection(){ 
		...
		this.model.selection("anodeSelection").set("xmin",beampiperadius-FSEzSpacing);
	...
	public void makeCathodeSelection(){
		...
		this.model.selection("cathodeSelection").set("xmin",beampiperadius-FSEzSpacing);
